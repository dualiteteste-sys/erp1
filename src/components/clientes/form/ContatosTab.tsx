...
export const ContatosTab: React.FC<ContatosTabProps> = ({ control }) => {
    ...
    <section>
      <div className="flex justify-between items-center mb-6">
        <div>
            ...
            <p className="text-sm text-gray-500">Gerencie os contatos secundários deste cliente/fornecedor.</p>
        </div>
                ...
                <div className="flex items-end gap-2">
                    <Controller name={`contatos.${index}.telefone`} control={control} render={({ field }) => (
                        <InputWrapper label="Telefone" className="flex-grow">
                            <IMaskInput mask="(00) 0000[0]-0000" className="glass-input" {...field} />
                        </InputWrapper>
                    )} />
